...
function builder(options) {
  ...
  if (!options.network) {
    options.network = bsv.Networks.defaultNetwork;
  }

  options.Block = options.Block || bsv.Block;
  options.BlockHeader = options.BlockHeader || bsv.BlockHeader;
  options.Transaction = options.Transaction || bsv.Transaction;
  options.MerkleBlock = options.MerkleBlock || bsv.MerkleBlock;
